...
var printInformation = function (p){
    var sentence = "Jmenuji se " + p.name + " a je mi " + p.age;     
 ...
 */
// Solution here
var printInformation = function (cislo) {
    var sentence = cislo.a + " je " + cislo.vysledek + " z " + cislo.b;
    console.log(sentence);
    };
    var addvol3 = function (a, b) {
        return ((a/b)*100 + "%");
    }
    addvol3 (4, 20);
    var addvol3 = 3.1415926535; addvol3.toFixed(2);
printInformation (addvol3);
