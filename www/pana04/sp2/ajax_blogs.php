...
if(isset($_POST["operation_type"])){
  ...
  if($_POST["operation_type"] == "signup"){
    if((isset($_POST["username"]))&&(isset($_POST["password"]))&&(isset($_POST["co_password"]))&&(isset($_POST["first"]))&&(isset($_POST["last"]))){
      // echo "OK";
      signup($_POST["username"], $_POST["password"], $_POST["co_password"], $_POST["first"], $_POST["last"]);
    }
  }
    ...
    if(isset($_POST["subject_type"])){
      ...
      else if($_POST["subject_type"] == "session_id"){
