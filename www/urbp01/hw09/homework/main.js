 ...
 */
//                        1         2
//              01234567890123456789012345  --> celkově 26 znaků
...
var decipher = document.querySelector("button");
...
decipher.onclick = function () {
    ...
    document.querySelector("div[class=out]").innerText = caesarDecipher(messageInput, cipherInput);
};
