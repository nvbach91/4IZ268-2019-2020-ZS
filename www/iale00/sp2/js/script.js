/*0. Setting variables
//$() takes any HTML element and turns it into a jQuery object.
var openForm = $('#open-form');
var formHeader = $('#form-header');
var formBody = $('#form-body');
var form = $('#form');
var myFavList = $('#my-favorite-list');
var reset = $('#reset'); //act as a selector
//attr() set the atribute and value in all <div>
var cover = $('<div>').attr('id', 'whole-page');//$('<div>') - construct elements
...
$(document).ready(() => {
    ...
    var hideForm = function () {
        ...
        reset.trigger('click'); //click on reset
        openedForm = false;
    };
    ...
    form.submit(function (ev) {
        ...
        var lang = $('#lng').val();
        var dataUrl = 'https://www.googleapis.com/books/v1/volumes?q=' + way + ':"' + question + '"&printType=books' + '&langRestrict=' + lang + '&maxResults=' + maxResult;
        console.log(dataUrl);
    ...
    var addToFavList = function (book, author, url, rating) {
        ...
        for(i = 0; i < stars.length; i++) {
            star += $('<span>').addClass('star').text('☆').attr('title', 'star-');
        }*/
