...
var printInformation = function (p){
    var sentence = "Moje jméno je " + p.name +  " a je mi" + p.age + " let"
...
console.log(comparison(5, 8));
console.log(comparison(2/9, 2/7));
console.log(comparison(2.4, 1.5));
...
//Bohužel se zbývajícími úlohami jsem si nevěděl rady